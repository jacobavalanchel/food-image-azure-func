...
vision_transformer = vit_base_patch16_224(
    num_classes=10)  # 将模型命名为vision_transformer，这里num_classes是数据集的种类，我用的猫狗数据集两类，所以等于2 你设置成你数据集的种类即可
...
# test1 = torch.ones(8, 3, 224, 224)  # 测试一下输出的形状大小 输入一个32,3,224,224的向量
